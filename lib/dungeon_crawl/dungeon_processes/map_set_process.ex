defmodule DungeonCrawl.DungeonProcesses.MapSetProcess do
  ...
  @doc """
  Returns true if the map set instance can have a score created for its parent map set,
  ...
  Sets the map set
  """
  def set_map_set(server, map_set) do
    GenServer.call(server, {:set_map_set, map_set})
  end
  ...
  Gets the map set id
  """
  def get_map_set(server) do
    GenServer.call(server, {:get_map_set})
  end
...
#    InstanceRegistry.link_map_set(program_registry, self())
  ...
  @impl true
  def handle_call({:scorable?}, _from, %{map_set: map_set, state_values: state_values} = state) do
    {:reply, map_set.active && ! map_set.autogenerated && ! state_values[:no_scoring], state}
  end

  @impl true
  def handle_call({:set_map_set, map_set}, _from, state) do
    {:reply, :ok, %{ state | map_set: map_set }}
  end
  ...
  @impl true
  def handle_call({:get_map_set}, _from, state) do
    {:reply, state.map_set, state}
  end
