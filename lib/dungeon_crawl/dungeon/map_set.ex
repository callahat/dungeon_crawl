defmodule DungeonCrawl.Dungeon.MapSet do
  ...
  def changeset(map_set, attrs) do
    ...
    map_set
    |> cast(attrs, [:name,:description,:version,:autogenerated,:active,:previous_version_id,:deleted_at,:user_id,:state,:default_map_width,:default_map_height, :line_identifier, :title_map_id])
    |> cast_assoc(:dungeons)
