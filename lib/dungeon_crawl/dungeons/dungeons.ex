defmodule DungeonCrawl.Dungeons do
  ...
  Expects the filters to be keyed using atoms, and the values to match the value
  in the database (ie, when filtering on :active, true must be given, "true" (the binary)
  will not match.
