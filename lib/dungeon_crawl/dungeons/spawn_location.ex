defmodule DungeonCrawl.Dungeons.SpawnLocation do
  ...
  def changeset(spawn_location, attrs, level_height, level_width) do
    ...
    |> validate_inclusion(:row, Range.new(0, level_height-1, 1), message: "must be between 0 and #{level_height-1}")
    |> validate_inclusion(:col, Range.new(0, level_width-1, 1), message: "must be between 0 and #{level_width-1}")
  end
end
