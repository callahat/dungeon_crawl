  ...
  def bandit do
    TileTemplates.update_or_create_tile_template!(
      ...
      %{character: "♣",
        ...
        state: "blocking: true, soft: true, destroyable: true, pushable: true, points: 5, blocking_light: false",
        color: "maroon",
        public: true,
        active: true,
        group_name: "monsters",
  ...
  def grid_bug do
    TileTemplates.update_or_create_tile_template!(
      ...
      %{character: "x",
        name: "Grid Bug",
        description: "Zap!",
        state: "blocking: true, soft: true, destroyable: true, points: 6, split_rate: 1, not_pushing: true, blocking_light: false",
        color: "purple",
        public: true,
        active: true,
        group_name: "monsters",
  ...
  def tiger do
    TileTemplates.update_or_create_tile_template!(
      ...
      %{character: "π",
        ...
        state: "int: 4, wis: 7, gun: 5, blocking: true, soft: true, destroyable: true, pushable: true, wait_cycles: 3, points: 10, blocking_light: false",
        color: "teal",
        public: true,
        active: true,
        group_name: "monsters",
