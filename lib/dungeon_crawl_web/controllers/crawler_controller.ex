defmodule DungeonCrawlWeb.CrawlerController do
  ...
  def _scorable_map_set(map_set) do
    if map_set do
      {:ok, parsed_state} = DungeonCrawl.StateValue.Parser.parse(map_set.map_set.state)
      map_set.map_set.active && ! map_set.map_set.autogenerated && ! parsed_state[:no_scoring]
    else
      false
    end
  end
