defmodule DungeonCrawlWeb.CrawlerController do
  ...
  def show(conn, _opts) do
    ...
    map_sets = if player_location,
                 do: [],
                 else: Dungeons.list_active_map_sets_with_player_count()
  ...
  def create(conn, _opts) do
    ...
    |> Multi.run(:map_set, fn(_repo, %{}) ->
        Dungeons.generate_map_set(@dungeon_generator, %{name: "Autogenerated", autogenerated: true}, dungeon_attrs)
      end)
  ...
  defp validate_instance_limit(%{params: %{"map_set_id" => map_set_id}} = conn, _opts) do
    if is_nil(Admin.get_setting.max_instances) or Dungeons.instance_count(map_set_id) < Admin.get_setting.max_instances do
      conn
    else
      conn
