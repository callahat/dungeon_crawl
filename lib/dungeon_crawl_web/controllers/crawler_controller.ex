...
#  end
  ...
  def show(conn, _opts) do
    ...
    dungeons_and_counts = if player_location, do: [], else: Dungeon.list_dungeons_with_player_count(:not_autogenerated)

    render(conn, "show.html", player_location: player_location, dungeons_and_counts: dungeons_and_counts)
  end
