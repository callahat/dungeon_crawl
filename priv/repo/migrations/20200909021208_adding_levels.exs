defmodule DungeonCrawl.Repo.Migrations.AddingLevels do
  ...
  def up do
    ...
    # TODO: update data
    execute """
      INSERT INTO map_sets(id, autogenerated, state, active, version, user_id,
                           deleted_at, inserted_at, updated_at)
             SELECT d0."id", d0."autogenerated", d0."state", d0."active", d0."version", d0."user_id",
                    d0."deleted_at", d0."inserted_at", d0."updated_at"
             FROM "dungeons" AS d0
    """
    execute """
      INSERT INTO map_set_instances(id, autogenerated, state, inserted_at, updated_at)
             SELECT g0.id, false as "autogenerated", g0.state, g0.inserted_at, g0.updated_at 
             FROM (SELECT d0."id", d0."state", d0."inserted_at", d0."updated_at"
                   FROM "map_instances" AS d0) AS g0
    """
    execute """
      UPDATE dungeons
