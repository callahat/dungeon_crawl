...
CREATE TABLE public.asset_imports (
    id bigint NOT NULL,
    type integer,
    importing_slug character varying(255),
    existing_slug character varying(255),
    resolved_slug character varying(255),
    action integer,
    attributes jsonb,
    dungeon_import_id bigint,
...
--
-- Name: asset_imports_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.asset_imports_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: asset_imports_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.asset_imports_id_seq OWNED BY public.asset_imports.id;
...
CREATE TABLE public.dungeon_instances (
    ...
    state character varying(2048) DEFAULT ''::character varying NOT NULL,
    dungeon_id bigint,
    inserted_at timestamp(0) without time zone NOT NULL,
    updated_at timestamp(0) without time zone NOT NULL,
...
--
-- Name: asset_imports id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_imports ALTER COLUMN id SET DEFAULT nextval('public.asset_imports_id_seq'::regclass);
...
--
-- Name: asset_imports asset_imports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_imports
...
--
-- Name: asset_imports_dungeon_import_id_type_importing_slug_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX asset_imports_dungeon_import_id_type_importing_slug_index ON public.asset_imports USING btree (dungeon_import_id, type, importing_slug);
...
--
-- Name: asset_imports asset_imports_dungeon_import_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_imports
    ADD CONSTRAINT asset_imports_dungeon_import_id_fkey FOREIGN KEY (dungeon_import_id) REFERENCES public.dungeon_imports(id) ON DELETE CASCADE;
...
INSERT INTO public."schema_migrations" (version) VALUES (20230904170339);
INSERT INTO public."schema_migrations" (version) VALUES (20231121200342);
