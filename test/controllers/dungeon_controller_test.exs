defmodule DungeonCrawlWeb.DungeonControllerTest do
  ...
  test "shows chosen resource with instance", %{conn: conn} do
    ...
    conn = get conn, dungeon_path(conn, :show, instance.dungeon, instance_id: instance.id)
    assert html_response(conn, 200) =~ "Dungeon: "
  end
  ...
  test "deletes chosen resource", %{conn: conn} do
    ...
    assert Repo.all(from mt in Dungeon.MapTile, where: mt.dungeon_id == ^dungeon.id) == []
  end
