defmodule DungeonCrawlWeb.Admin.LevelProcessControllerTest do
  ...
  describe "non registered users" do
    test "redirects non admin users", %{conn: conn} do
      conn = get conn, admin_level_process_path(conn, :show, 1, 1, "none")
  ...
  describe "with an admin user" do
    ...
    test "shows chosen instance", %{conn: conn} do
      ...
      conn = get conn, admin_level_process_path(conn, :show, instance.dungeon_instance_id, instance.number, instance.player_location_id || "none")
    ...
    test "shows chosen instance when its owned by a player", %{conn: conn} do
      ...
      conn = get conn, admin_level_process_path(conn, :show, instance.dungeon_instance_id, instance.number, instance.player_location_id)
      assert html_response(conn, 200) =~ "DB Backed Level Instance Process"
    end
    ...
    test "shows chosen instance when no backing db instance", %{conn: conn} do
      ...
      conn = get conn, admin_level_process_path(conn, :show, instance.dungeon_instance_id, 2, instance.player_location_id || "none")
