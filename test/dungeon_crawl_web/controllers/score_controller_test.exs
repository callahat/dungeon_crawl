defmodule DungeonCrawlWeb.ScoreControllerTest do
  ...
  setup %{conn: conn} do
    ...
    {:ok, score1} = Scores.create_score(%{map_set_id: map_set_1.id, user_id_hash: user_1.user_id_hash, score: 1})
    ...
    {:ok, conn: conn, user_1: user_1, user_2: user_2, map_set_1: map_set_1, map_set_2: map_set_2, score: score1}
  end
  ...
  describe "index" do
    ...
    test "lists all scores for map set and specific score", %{conn: conn, map_set_1: map_set_1, map_set_2: map_set_2} do
    ...
    test "lists all scores for map set", %{conn: conn, map_set_1: map_set_1, score: score} do
      conn = get(conn, score_path(conn, :index, map_set_id: map_set_1.id, score_id: score.id))
