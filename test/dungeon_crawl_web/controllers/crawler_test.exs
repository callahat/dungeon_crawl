defmodule DungeonCrawlWeb.CrawlerTest do
  ...
  test "join_and_broadcast/3 joining a dungeon" do
    map_set = insert_autogenerated_map_set()
    assert %Player.Location{} = location = Crawler.join_and_broadcast(map_set, "itsmehash", true)
  ...
  test "join_and_broadcast/2 joining an instance" do
    ...
    assert %Player.Location{} = location = Crawler.join_and_broadcast(msi, "itsmehash")
    map_tile = Repo.preload(location, :map_tile).map_tile
