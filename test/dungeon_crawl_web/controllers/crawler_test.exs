defmodule DungeonCrawlWeb.CrawlerTest do
  ...
  test "join_and_broadcast/2 joining a dungeon" do
    ...
    assert %Player.Location{} = location = Repo.preload(Crawler.join_and_broadcast(map_set, "itsmehash"), :map_tile)
  ...
  test "join_and_broadcast/2 joining an instance" do
    ...
    assert %Player.Location{} = location = Repo.preload(Crawler.join_and_broadcast(msi, "itsmehash"), :map_tile)
