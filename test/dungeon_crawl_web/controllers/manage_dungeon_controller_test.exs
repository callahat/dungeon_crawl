defmodule DungeonCrawlWeb.ManageDungeonControllerTest do
  ...
  describe "with an admin user" do
    ...
    test "shows chosen resource with instance", %{conn: conn} do
      dungeon_instance = Repo.preload insert_autogenerated_dungeon_instance(), :dungeon
      conn = get conn, manage_dungeon_path(conn, :show, dungeon_instance.dungeon, instance_id: dungeon_instance.id)
      assert html_response(conn, 200) =~ "Dungeon: "
    end
