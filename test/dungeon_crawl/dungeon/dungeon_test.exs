...
# TODO: update these
    test "list_dungeons_with_player_count/0 returns all dungeons with count of players in them" do
      ...
      assert Dungeon.list_dungeons_with_player_count() == [%{dungeon: Repo.preload(map, :dungeon).dungeon, player_count: 0, instance: map}]
      insert_player_location(%{map_instance_id: map.id})
      insert_player_location(%{map_instance_id: map.id, user_id_hash: "different"})
      assert Dungeon.list_dungeons_with_player_count() == [%{dungeon: Repo.preload(map, :dungeon).dungeon, player_count: 2, instance: map}]
    end
    ...
    test "list_dungeons_with_player_count/1 returns all dungeons with count of players in them" do
      ...
      insert_player_location(%{map_instance_id: map.id})
      assert Dungeon.list_dungeons_with_player_count(:not_autogenerated) == [%{dungeon: Repo.preload(map, :dungeon).dungeon, player_count: 1, instance: map}]
    end
