  ...
  describe "map_sets" do
    ...
    test "copy_map_set_fields/1" do
      ...
      assert %{autogenerated: false,
               ...
               state: nil,
               user_id: nil,
               line_identifier: map_set.line_identifier} == Dungeon.copy_map_set_fields(map_set)
    end

    test "create_map_set/1 with valid data creates a map" do
      assert {:ok, %MapSet{} = map_set} = Dungeon.create_map_set(@valid_attrs)
  ...
  describe "dungeons" do
    ...
    test "copy_map_fields/1" do
      ...
      assert %{entrance: nil,
               ...
               number_west: nil,
               state: nil,
               width: 20} == Dungeon.copy_map_fields(map)
    end
    ...
    test "adjacent_map_edge_tiles/1" do
      ...
      assert %{north: nil,
               ...
               east: eastern_edge_tiles} = Dungeon.adjacent_map_edge_tiles(map_1)
    ...
    test "adjacent_map_edge_tile/2" do
      ...
      assert %{north: northern_edge_tiles} = Dungeon.adjacent_map_edge_tile(map_1, "north")
    ...
    test "map_edge_tiles/3" do
      ...
      assert northern_edge_tiles = Dungeon.map_edge_tiles(map_2, "south")
      ...
      # Bad input
      refute Dungeon.map_edge_tiles(nil, "north")
      refute Dungeon.map_edge_tiles(map_1, nil)

      # other attributes selected, nilling out other attrs not selected
      expected = Enum.map(0..20, fn _ -> %{character: " ", row: nil, col: nil} end)
      actual = Dungeon.map_edge_tiles(map_2, "south", [:character])
  ...
  describe "dungeon_map_tiles" do
    ...
    test "copy_map_tile_fields/1" do
      ...
      assert %{animate_background_colors: nil,
               ...
               z_index: 0} == Dungeon.copy_map_tile_fields(map_tile)
    end
