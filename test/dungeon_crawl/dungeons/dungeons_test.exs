defmodule DungeonCrawl.DungeonsTest do
  ...
  describe "dungeons" do
    ...
    test "list_active_dungeons/2 returns a list of filtered dungeons" do
      ...
      # has saves
      level = insert_autogenerated_level_instance(%{dungeon_id: dungeon2.id})
      save_fixture(%{user_id_hash: user.user_id_hash, level_instance_id: level.id})
      assert Enum.map(Dungeons.list_active_dungeons(%{has_saves: true}, user.user_id_hash), &(&1.name)) ==
               [ dungeon2.name ]
    end
    ...
    test "get_current_dungeon/1" do
      ...
      dungeon3 = dungeon_fixture(%{active: false, version: 3, line_identifier: dungeon.line_identifier})
      ...
      assert yet_another_dungeon == Dungeons.get_current_dungeon(line_identifier)
    end
