defmodule DungeonCrawl.Scripting.CommandTest do
  ...
  test "BECOME" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, character: ".", level_instance_id: 1})
    ...
    updated_tile = Instances.get_tile_by_id(state, tile)
  ...
  test "BECOME when script should be unaffected" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, character: ".", level_instance_id: 1, script: "#END\n:TOUCH\n*creak*"})
  ...
  test "BECOME a SLUG the author cannot use ignores the slug" do
    ...
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, character: ".", level_instance_id: 1, state: ""})
    ...
    assert %{character: "!", state: "blocking: true"} = Instances.get_tile_by_id(updated_state, tile)
    ...
    assert %{character: ".", state: ""} = Instances.get_tile_by_id(updated_state, tile)
  ...
  test "BECOME a SLUG" do
    ...
    %Runner{state: state} = Command.become(%Runner{program: program, object_id: tile.id, state: state}, params)
    not_updated_tile = Instances.get_tile_by_id(state, updated_tile)
  ...
  test "CHANGE_STATE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: ".", state: "one: 100, add: 8"})
    program = program_fixture()

    %Runner{state: updated_state} = Command.change_state(%Runner{program: program, object_id: tile.id, state: state}, [:add, "+=", 1])
    updated_tile = Instances.get_tile_by_id(updated_state, tile)
    ...
    # when its a new tile
    {new_tile, state} = Instances.create_tile(state, %Tile{id: "new_1", row: 1, col: 2, z_index: -1, character: ".", state: "fresh: true"})
    %Runner{state: updated_state} = Command.change_state(%Runner{object_id: new_tile.id, state: state}, [:new, "+=", 1])
    updated_new_tile = Instances.get_tile_by_id(updated_state, new_tile)
    top_tile = Instances.get_tile_by_id(updated_state, tile)
    assert updated_new_tile.state == "fresh: true, new: 1"
    assert top_tile.state == tile.state
  end

  test "CHANGE_INSTANCE_STATE" do
    {_tile, state} = Instances.create_tile(%Instances{state_values: %{one: 100, add: 8}}, %Tile{id: 123, row: 1, col: 2, character: "."})
  ...
  test "CHANGE_MAP_SET_INSTANCE_STATE" do
    ...
    state = %Instances{state_values: %{a: 5}, dungeon_instance_id: dungeon_instance.id}
    {_tile, state} = Instances.create_tile(state, %Tile{id: 123, row: 1, col: 2, character: "."})
  ...
  test "CHANGE_OTHER_STATE" do
    {tile_1, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: "@", state: "one: 100, add: 8, player: true"})
    {tile_2, state} = Instances.create_tile(state, %Tile{id: 124, row: 0, col: 2, z_index: 0, character: ".", state: "one: 1"})
    program = program_fixture()
    ...
    updated_tile = Instances.get_tile_by_id(updated_state, tile_2)
  ...
  test "CYCLE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: "."})
    program = program_fixture()

    %Runner{state: state} = Command.cycle(%Runner{program: program, object_id: tile.id, state: state}, [3])
    tile = Instances.get_tile_by_id(state, tile)
  ...
  test "COMPOUND_MOVE" do
    {_, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 2, z_index: 0})
    {mover, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", row: 1, col: 2, z_index: 1})
    ...
    %Runner{program: program, state: state} = Command.compound_move(%Runner{object_id: mover.id, state: state},
                                                                    [{"west", true}, {"east", true}])
    mover = Instances.get_tile_by_id(state, mover)
    assert %{status: :wait,
             wait_cycles: 5,
             broadcasts: [],
             pc: 0,
  ...
  test "DIE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 1, character: "$"})
    {under_tile, state} = Instances.create_tile(state, %Tile{id: 45, row: 1, col: 2, z_index: 0, character: "."})
    program = program_fixture()

    %Runner{program: program, state: state} = Command.die(%Runner{program: program, object_id: tile.id, state: state})
    updated_tile = Instances.get_tile_by_id(state, tile)
    assert under_tile == Instances.get_tile(state, tile)
    assert program.status == :dead
    assert program.pc == -1
    refute updated_tile
  ...
  test "GAMEOVER" do
    ...
    state = %Instances{state_values: %{rows: 20, cols: 20},
                       ...
                       instance_id: instance.id}
    {player_tile_1, state} = Instances.create_player_tile(state, player_tile_1, %Location{})
    {player_tile_2, state} = Instances.create_player_tile(state, player_tile_2, %Location{})
  ...
  test "GAMEOVER with bad target doesnt crash game" do
    ...
    {_player_tile_1, state} = Instances.create_player_tile(state, player_tile_1, player_location_1)
  ...
  test "GIVE" do
    script = """
             ...
             """
    {receiving_tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: "E", row: 1, col: 1, z_index: 0, state: "health: 1"})
    {giver, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", row: 2, col: 1, z_index: 1, state: "medkits: 3", script: script, color: "red"})
...
#    stubbed_state = %{map_by_ids: %{1 => stubbed_object}}
  ...
  test "FACING" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: ".", state: "facing: up, rico: west"})
    {west_tile, state} = Instances.create_tile(state, %Tile{id: 124, row: 1, col: 1, z_index: 1, character: "."})
    program = program_fixture()
    ...
    {fake_player, state} = Instances.create_player_tile(state, %Tile{id: 43201, row: 2, col: 2, z_index: 0, character: "@"}, %Location{})
    runner_state = %Runner{program: program, object_id: tile.id, state: state}
    %Runner{state: updated_state} = Command.facing(runner_state, ["player"])
    updated_tile = Instances.get_tile_by_id(updated_state, tile)
    ...
    {_fake_player, state} = Instances.delete_tile(state, fake_player)
    runner_state = %Runner{program: program, object_id: tile.id, state: state}
    %Runner{state: updated_state} = Command.facing(runner_state, ["player"])
    updated_tile = Instances.get_tile_by_id(updated_state, tile)
    assert updated_tile.state == "facing: idle, rico: west, target_player_map_tile_id: nil"
  ...
  test "FACING - derivative when facing state var does not exist" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: "."})
    {_west_tile, state} = Instances.create_tile(state, %Tile{id: 124, row: 1, col: 1, z_index: 1, character: "."})
    program = program_fixture()
  ...
  test "JUMP_IF when state check is TRUE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, state: "thing: true", color: "red", background_color: "white"})
    program = program_fixture()
...
#    state = %Instances{map_by_ids: %{1 => stubbed_object}}
  ...
  test "JUMP_IF when state check is FALSE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, state: "thing: true"})
    program = program_fixture()
#    stubbed_object = %{state: "thing: true", parsed_state: %{thing: true}}
  ...
  test "JUMP_IF when using a check against a variable on the event sender" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1})
  ...
  test "JUMP_IF when using a check against an instance state value" do
    {tile, state} = Instances.create_tile(%Instances{state_values: %{red_flag: true}}, %Tile{id: 1})
    program = program_fixture()
  ...
  test "JUMP_IF when using a check against a tile in a direction" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, row: 1, col: 1})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, row: 0, col: 1, state: "password: bob"})
    program = program_fixture()
  ...
  test "LOCK" do
    ...
    tile = Instances.get_tile(state, tile)
  ...
  test "MOVE with one param" do
    {_, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 2, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 4, character: "#", row: 0, col: 1, z_index: 0, state: "blocking: true"})
    {mover, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", row: 1, col: 2, z_index: 1})
    ...
    {another_fake_player, state} = Instances.create_player_tile(state, %Tile{id: 43215, row: 1, col: 5, z_index: 0, character: "@"}, %Location{})
    ...
    {_, state} = Instances.delete_tile(state, fake_player)
    ...
    assert %{row: 2,
             ...
             z_index: 1} = mover
    {_, state} = Instances.delete_tile(state, another_fake_player)
  ...
  test "MOVE with two params" do
    ...
    mover = Instances.get_tile_by_id(updated_state, mover)
    assert %{status: :wait,
             wait_cycles: 5,
             broadcasts: [],
             pc: 1
  ...
  test "MOVE using a state variable" do
    {_, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 2, z_index: 0})
    {mover, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", row: 1, col: 2, z_index: 1, state: "facing: west"})
  ...
  test "MOVE into something blocking (or a nil square) triggers a THUD event" do
    {_, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 2, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 4, character: ".", row: 2, col: 2, z_index: 0, state: "blocking: true"})
    {mover, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", row: 1, col: 2, z_index: 1})
  ...
  test "PASSAGE" do
    {tile_1, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, character: "<"})
    {tile_2, state} = Instances.create_tile(state, %Tile{id: 124, row: 1, col: 4, character: ">", background_color: "puce"})
  ...
  test "PULL" do
    state = %Instances{}
    {_, state} = Instances.create_tile(state, %Tile{id: 1, character: ".", row: 0, col: 1, z_index: 0})
    {pulled, state} = Instances.create_tile(state, %Tile{id: 5, character: "P", row: 0, col: 1, z_index: 1, state: "pullable: true"})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 1, z_index: 0})
    {puller, state} = Instances.create_tile(state, %Tile{id: 4, character: "@", row: 1, col: 1, z_index: 1, script: "#PULL south\n#NOOP"})
    {_, state} = Instances.create_tile(state, %Tile{id: 3, character: ".", row: 2, col: 1, z_index: 0})
    ...
    pulled = Instances.get_tile_by_id(state, pulled)
    puller = Instances.get_tile_by_id(state, puller)
    assert %{broadcasts: [],
            status: :wait,
            wait_cycles: 5,
            pc: 1
    ...
    assert %{row: 1, col: 1, character: "P", z_index: 1} = Instances.get_tile_by_id(state, pulled)
    assert %{row: 2, col: 1, character: "@", z_index: 1} = Instances.get_tile_by_id(state, puller)
  ...
  test "PUSH" do
    state = %Instances{}
    {_, state} = Instances.create_tile(state, %Tile{id: 1, character: ".", row: 0, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 5, character: "@", row: 0, col: 1, z_index: 1, state: "pushable: true, blocking: true"})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 3, character: ".", row: 2, col: 1, z_index: 0})
    {pusher, state} = Instances.create_tile(state, %Tile{id: 4, character: "P", row: 3, col: 1, z_index: 0, state: "facing: north, side: norf, pushable: true"})
    ...
    # Pushes
    {pushed, state} = Instances.create_tile(state, %Tile{id: 6, character: "2", row: 2, col: 1, z_index: 1, state: "pushable: true, blocking: true"})
    runner_state = %Runner{object_id: pusher.id, state: state}
    %Runner{program: program, state: state} = Command.push(runner_state, [{:state_variable, :facing}, 3])
    pushed = Instances.get_tile_by_id(state, pushed)
  ...
  test "PUT" do
    ...
    tile = Instances.get_tile(state, %{row: 1, col: 2})
    ...
    new_tile = Instances.get_tile(updated_state, %{row: 2, col: 2})
...
#    assert new_tile.slug == squeaky_door.slug
    ...
    %Runner{program: program, state: updated_state} = Command.put(runner_state, params)
    tile_1_3 = Instances.get_tile(updated_state, %{row: 1, col: 3})
    ...
    %Runner{program: program, state: updated_state} = Command.put(runner_state, params)
    tile_1_3 = Instances.get_tile(updated_state, %{row: 1, col: 3})
    tile_1_4 = Instances.get_tile(updated_state, %{row: 1, col: 4})
  ...
  test "PUT using coordinates" do
    ...
    new_tile = Instances.get_tile(updated_state, %{row: 4, col: 2})
    assert program.broadcasts == []
    ...
    new_tile = Instances.get_tile(updated_state, %{row: 3, col: 2})
    assert new_tile.character == "!"
  ...
  test "RANDOM" do
    dungeon_instance = insert_stubbed_dungeon_instance(%{state: "di_thing1: 999, di_flag: false"})
    state = %Instances{dungeon_instance_id: dungeon_instance.id}

    {tile, state} = Instances.create_tile(state, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: ".", state: ""})
  ...
  test "REPLACE tile in a direction" do
    ...
    state = %Instances{}
    {tile_123, state}  = Instances.create_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 2, z_index: 0, script: "#END", level_instance_id: 1})
    {_tile_255, state} = Instances.create_tile(state, %Tile{id: 255,  character: ".", row: 1, col: 2, z_index: 1, script: "#END", level_instance_id: 1})
    {_tile_999, state} = Instances.create_tile(state, %Tile{id: 999,  character: "c", row: 3, col: 2, z_index: 0, level_instance_id: 1})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, character: "c", row: 2, col: 2, z_index: 0, state: "facing: north", level_instance_id: 1, script: "#end"})
    ...
    assert Instances.get_tile_by_id(updated_state, %{id: 255}).color == "beige"
    assert Instances.get_tile_by_id(updated_state, %{id: 123}).color == tile_123.color
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 1, col: 2}

    %Runner{state: updated_state, program: program} = Command.replace(runner_state, [%{target: "south", color: "beige"}])
    assert Instances.get_tile_by_id(updated_state, %{id: 999}).color == "beige"
    assert program.broadcasts == []
    ...
    assert Instances.get_tile_by_id(updated_state, %{id: 255}).color == "beige"
    refute Instances.get_tile_by_id(updated_state, %{id: 123}).color == "beige"
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 1, col: 2}
  ...
  test "REPLACE tiles by name" do
    ...
    state = %Instances{}
    {tile_123, state} = Instances.create_player_tile(state, %Tile{id: 123,  name: "A", character: ".", row: 1, col: 2, z_index: 0, script: "#END", level_instance_id: 1}, %Location{})
    {tile_255, state} = Instances.create_tile(state, %Tile{id: 255,  name: "A", character: ".", row: 1, col: 2, z_index: 1, script: "#END", level_instance_id: 1})
    {tile_999, state} = Instances.create_tile(state, %Tile{id: 999,  name: "C", character: "c", row: 3, col: 2, z_index: 0, script: "#END", level_instance_id: 1})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, name: nil, character: "c", row: 2, col: 2, z_index: 0, level_instance_id: 1})
    ...
    assert Instances.get_tile_by_id(updated_state, %{id: 255}) == tile_255
    assert Instances.get_tile_by_id(updated_state, %{id: 123}) == tile_123
    assert Instances.get_tile_by_id(updated_state, %{id: 999}) == tile_999
    assert program.broadcasts == []
    assert program.pc == tile_program.pc

    %Runner{state: updated_state, program: program} = Command.replace(runner_state, [%{target: "a", slug: squeaky_door.slug}])
    assert Instances.get_tile_by_id(updated_state, %{id: 255}).character == squeaky_door.character
    assert Instances.get_tile_by_id(updated_state, %{id: 123}) == tile_123
    assert Instances.get_tile_by_id(updated_state, %{id: 999}) == tile_999
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 1, col: 2}
    ...
    assert Instances.get_tile_by_id(updated_state, %{id: 999}).character == squeaky_door.character
    assert Instances.get_tile_by_id(updated_state, %{id: 255}) == tile_255
    assert Instances.get_tile_by_id(updated_state, %{id: 123}) == tile_123
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 3, col: 2}
  ...
  test "REPLACE with only target_ kwargs" do
    ...
    state = %Instances{}
    {tile_123, state} = Instances.create_player_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 2, z_index: 0, script: "#END", level_instance_id: 1}, %Location{})
    {_tile_255, state} = Instances.create_tile(state, %Tile{id: 255, character: ".", row: 1, col: 2, z_index: 1, color: "red", state: "me: true", script: "#END", level_instance_id: 1})
    {tile_999, state} = Instances.create_tile(state, %Tile{id: 999, character: "c", row: 3, col: 2, z_index: 0, script: "#END", level_instance_id: 1})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, name: nil, character: "c", row: 2, col: 2, z_index: 0, level_instance_id: 1})
  ...
  test "REMOVE tile in a direction" do
    state = %Instances{}
    {_, state}   = Instances.create_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 2, z_index: 0, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 255,  character: ".", row: 1, col: 2, z_index: 1, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 999,  character: "c", row: 3, col: 2, z_index: 0})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, character: "c", row: 2, col: 2, z_index: 0, state: "facing: north"})
    ...
    refute Instances.get_tile_by_id(updated_state, %{id: 255})
    assert Instances.get_tile_by_id(updated_state, %{id: 123})
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 1, col: 2}

    %Runner{state: updated_state, program: program} = Command.remove(runner_state, [%{target: "south"}])
    refute Instances.get_tile_by_id(updated_state, %{id: 999})
    assert program.broadcasts == []
    assert Map.has_key? updated_state.rerender_coords, %{row: 3, col: 2}
  ...
  test "REMOVE tiles by name" do
    state = %Instances{}
    {_, state}   = Instances.create_tile(state, %Tile{id: 123,  name: "A", character: ".", row: 1, col: 2, z_index: 0, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 255,  name: "A", character: ".", row: 1, col: 2, z_index: 1, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 999,  name: "C", character: "c", row: 3, col: 2, z_index: 0, script: "#END"})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, name: nil, character: "c", row: 2, col: 2, z_index: 0})

    %Runner{state: updated_state} = Command.remove(%Runner{state: state, object_id: obj.id}, [%{target: "a", target_color: "red"}])
    assert Instances.get_tile_by_id(updated_state, %{id: 255})
    assert Instances.get_tile_by_id(updated_state, %{id: 123})

    %Runner{state: updated_state} = Command.remove(%Runner{state: state, object_id: obj.id}, [%{target: "a"}])
    refute Instances.get_tile_by_id(updated_state, %{id: 255})
    refute Instances.get_tile_by_id(updated_state, %{id: 123})
  ...
  test "REMOVE tiles with only other target KWARGS" do
    state = %Instances{}
    {_, state}   = Instances.create_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 2, z_index: 0, color: "red"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 255,  character: ".", row: 1, col: 2, z_index: 1, state: "moo: cow"})
    {_, state}   = Instances.create_player_tile(state, %Tile{id: 999,  character: "c", row: 3, col: 2, z_index: 0, color: "red"}, %Location{})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, character: "c", row: 2, col: 2, z_index: 0})
    ...
    assert Instances.get_tile_by_id(updated_state, %{id: 999})
    refute Instances.get_tile_by_id(updated_state, %{id: 123})
  end
  ...
  test "SEND message to tiles in a direction" do
    ...
    {_, state}   = Instances.create_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 2, z_index: 0, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 255,  character: ".", row: 1, col: 2, z_index: 1, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 999,  character: "c", row: 3, col: 2, z_index: 0, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 998,  character: ".", row: 2, col: 2, z_index: -1, script: ""})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, character: "c", row: 2, col: 2, z_index: 0, state: "facing: north"})
  ...
  test "SEND message to tiles by id" do
    state = %Instances{}
    {_, state}   = Instances.create_tile(state, %Tile{id: 123, character: ".", row: 1, col: 2, z_index: 0, script: "#END"})
    {_, state}   = Instances.create_tile(state, %Tile{id: "new_1", character: ".", row: 1, col: 2, z_index: 1, script: "#END"})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, name: nil, character: "c", row: 2, col: 2, z_index: 0})
    sender = %{tile_id: obj.id, parsed_state: %{}, name: nil}
  ...
  test "SEQUENCE" do
    {tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 123, row: 1, col: 2, z_index: 0, character: ".", state: ""})
  ...
  test "SHIFT" do
    state = %Instances{}
    {_, state}   = Instances.create_tile(state, %Tile{id: 123,  character: ".", row: 1, col: 1, z_index: 0})
    {_, state}   = Instances.create_tile(state, %Tile{id: 601,  character: "o", row: 1, col: 1, z_index: 1, state: "blocking: true, pushable: true"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 124,  character: ".", row: 1, col: 2, z_index: 0})
    {_, state}   = Instances.create_tile(state, %Tile{id: 125,  character: "#", row: 1, col: 3, z_index: 0, state: "blocking: true"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 126,  character: ".", row: 2, col: 3, z_index: 0})
    {_, state}   = Instances.create_tile(state, %Tile{id: 602,  character: "o", row: 2, col: 3, z_index: 1, state: "blocking: true, pushable: true"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 127,  character: ".", row: 3, col: 1, z_index: 0})
    {_, state}   = Instances.create_tile(state, %Tile{id: 128,  character: ".", row: 3, col: 2, z_index: 0})
    {_, state}   = Instances.create_tile(state, %Tile{id: 603,  character: "o", row: 3, col: 2, z_index: 1, state: "blocking: true, pushable: true"})
    {_, state}   = Instances.create_tile(state, %Tile{id: 129,  character: ".", row: 3, col: 3, z_index: 0})
    {obj, state} = Instances.create_tile(state, %Tile{id: 1337, character: "/", row: 2, col: 2, z_index: 0})

    state = %{ state | rerender_coords: %{} }

    obj_123 = Instances.get_tile_by_id(state, %{id: 123})
    obj_124 = Instances.get_tile_by_id(state, %{id: 124})
    obj_125 = Instances.get_tile_by_id(state, %{id: 125})
    obj_126 = Instances.get_tile_by_id(state, %{id: 126})
    obj_127 = Instances.get_tile_by_id(state, %{id: 127})
    obj_128 = Instances.get_tile_by_id(state, %{id: 128})
    obj_129 = Instances.get_tile_by_id(state, %{id: 129})

    %Runner{state: updated_state, program: program} = Command.shift(%Runner{state: state, object_id: obj.id}, ["clockwise"])
    assert %{id: 601, row: 1, col: 2, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 601})
    assert %{id: 602, row: 3, col: 3, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 602})
    assert %{id: 603, row: 3, col: 1, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 603})
    assert %{status: :wait,
             wait_cycles: 5,
             broadcasts: [],
             pc: 1
    ...
    assert obj_123 == Instances.get_tile_by_id(updated_state, %{id: 123})
    assert obj_124 == Instances.get_tile_by_id(updated_state, %{id: 124})
    assert obj_125 == Instances.get_tile_by_id(updated_state, %{id: 125})
    assert obj_126 == Instances.get_tile_by_id(updated_state, %{id: 126})
    assert obj_127 == Instances.get_tile_by_id(updated_state, %{id: 127})
    assert obj_128 == Instances.get_tile_by_id(updated_state, %{id: 128})
    assert obj_129 == Instances.get_tile_by_id(updated_state, %{id: 129})

    %Runner{state: updated_state, program: program} = Command.shift(%Runner{state: updated_state, object_id: obj.id}, ["clockwise"])
    assert %{id: 601, row: 1, col: 2, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 601})
    assert %{id: 602, row: 3, col: 2, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 602})
    assert %{id: 603, row: 3, col: 1, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 603})
    assert %{status: :wait,
             wait_cycles: 5,
             broadcasts: [],
    ...
    assert %{id: 601, row: 1, col: 1, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 601})
    assert %{id: 602, row: 3, col: 3, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 602})
    assert %{id: 603, row: 3, col: 2, z_index: 1} = Instances.get_tile_by_id(updated_state, %{id: 603})
    assert %{status: :wait,
             wait_cycles: 5,
             broadcasts: [],
             pc: 1
  ...
  test "SHOOT" do
    ...
    obj = Instances.get_tile(state, %{row: 2, col: 2})
    ...
    tile = Instances.get_tile(updated_state, %{row: 2, col: 2})

    assert tile.character == "@"

    # when there is a player
    {_, state_w_player} = Instances.create_player_tile(state,
...
#    obj = %{obj | parsed_state: %{facing: "north"}}
    {obj, state} = Instances.update_tile_state(updated_state, obj, %{facing: "north"})
  ...
  test "TAKE" do
    script = """
             ...
             """
    {losing_tile, state} = Instances.create_tile(%Instances{}, %Tile{id: 1, character: "E", row: 1, col: 1, z_index: 0, state: "health: 10, red: 1, cash: 2"})
    {taker, state} = Instances.create_tile(state, %Tile{id: 3, character: "c", color: "red", row: 2, col: 1, z_index: 1, state: "damage: 3", script: script})
  ...
  test "TARGET_PLAYER" do
    # setup
    state = %Instances{}
    {_, state} = Instances.create_player_tile(state,
    ...
    {_, state} = Instances.create_player_tile(state,
                                              ...
                                              %Location{})
    {object_1, state} = Instances.create_tile(state, %Tile{id: 1, character: "X", row: 2, col: 3, z_index: 0, state: ""})
    {object_2, state} = Instances.create_tile(state, %Tile{id: 2, character: "Y", row: 5, col: 20, z_index: 0, state: ""})
    ...
    object_tile = Instances.get_tile_by_id(updated_state, object_1)
    target_tile = Instances.get_tile_by_id(updated_state, %{id: object_tile.parsed_state[:target_player_map_tile_id]})
    assert Enum.member?(["A", "C"], target_tile.character)

    runner_state = %Runner{object_id: object_2.id, state: state}
    %Runner{state: updated_state} = Command.target_player(runner_state, ["nearest"])
    object_tile = Instances.get_tile_by_id(updated_state, object_2)
    target_tile = Instances.get_tile_by_id(updated_state, %{id: object_tile.parsed_state[:target_player_map_tile_id]})
  ...
  test "TERMINATE" do
    ...
    updated_tile = Instances.get_tile_by_id(state, tile)
    assert updated_tile == Instances.get_tile(state, tile)
    assert program.status == :dead
    assert program.pc == -1
  ...
  test "TRANSPORT" do
    ...
    {floor, state} = Instances.create_tile(%Instances{number: 3}, %Tile{id: 1, character: ".", row: 1, col: 1, z_index: 0})
    {_, state} = Instances.create_tile(state, %Tile{id: 2, character: ".", row: 1, col: 2, z_index: 0})
    {fake_player, state} = Instances.create_player_tile(state,
