defmodule DungeonCrawl.Action.DoorTest do
  ...
  test "open/1 opens a closed door" do
    ...
    dungeon = insert_stubbed_dungeon(%{}, [%{row: 1, col: 1, tile: closed_door.character, tile_template_id: closed_door.id}])
  ...
  test "open/1 is invalid for anything other than a closed door" do
    ...
    dungeon = insert_stubbed_dungeon(%{}, [%{row: 4, col: 5, tile: real_fake_door.character, tile_template_id: real_fake_door.id}])
  ...
  test "close/1 closes an open door" do
    ...
    dungeon = insert_stubbed_dungeon(%{}, [%{row: 2, col: 3, tile: open_door.character, tile_template_id: open_door.id}])
  ...
  test "close/1 is invalid for anything other than an open door" do
    ...
    dungeon = insert_stubbed_dungeon(%{}, [%{row: 8, col: 9, tile: real_fake_door.character, tile_template_id: real_fake_door.id}])
