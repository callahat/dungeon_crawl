defmodule DungeonCrawl.Action.DoorTest do
  ...
  test "open/1 opens a closed door" do
    ...
    dungeon = insert_stubbed_dungeon_instance(%{}, [%{row: 1, col: 1, tile_template_id: closed_door.id, z_index: 0}])
  ...
  test "open/1 is invalid for anything other than a closed door" do
    ...
    dungeon = insert_stubbed_dungeon_instance(%{}, [%{row: 4, col: 5, tile_template_id: real_fake_door.id, z_index: 0}])
  ...
  test "close/1 closes an open door" do
    ...
    dungeon = insert_stubbed_dungeon_instance(%{}, [%{row: 2, col: 3, tile_template_id: open_door.id, z_index: 0}])
  ...
  test "close/1 is invalid for anything other than an open door" do
    ...
    dungeon = insert_stubbed_dungeon_instance(%{}, [%{row: 8, col: 9, tile_template_id: real_fake_door.id, z_index: 0}])
