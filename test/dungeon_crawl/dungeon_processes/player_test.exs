defmodule DungeonCrawl.DungeonProcesses.PlayerTest do
  ...
  setup do
    ...
    player_location = insert_player_location(%{map_instance_id: instance.id,
                                               row: 2,
                                               col: 2,
                                               state: "ammo: 4, health: 100, cash: 420, gems: 1",
  ...
  test "current_stats/2", %{state: state, player_map_tile: player_map_tile} do
    assert %{ammo: 4, cash: 420, gems: 1, health: 100} == Player.current_stats(state, player_map_tile)
  end
  ...
  test "current_stats/1" do
    assert %{ammo: 4, cash: 420, gems: 1, health: 100} == Player.current_stats(@user_id_hash)
  end
