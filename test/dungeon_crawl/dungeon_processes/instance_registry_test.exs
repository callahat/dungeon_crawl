defmodule DungeonCrawl.InstanceRegistryTest do
  ...
  test "create/2", %{instance_registry: instance_registry} do
    ...
    assert %Instances{program_contexts: programs} = InstanceProcess.inspect_state(instance_process)
  ...
  test "create/3", %{instance_registry: instance_registry} do
    ...
    # the instance map is loaded
    assert %Instances{program_contexts: programs, map_by_ids: by_ids, map_by_coords: by_coords} = InstanceProcess.inspect_state(instance_process)
    ...
    assert %Instances{program_contexts: programs, map_by_ids: by_ids, map_by_coords: by_coords} = InstanceProcess.inspect_state(instance_process2)
