defmodule DungeonCrawl.DungeonGeneration.MapGenerators.DrunkardsWalkTest do
  ...
  test "generate returns a map with a rol, col tuple as key and tile as value" do
    dungeon_map = DrunkardsWalk.generate(20,20)
  ...
  test "generate returns a map stairs up" do
    dungeon_map = DrunkardsWalk.generate(20,20,1)
